...
setup(
    ...
    packages=['venv.Lib.distutils', 'venv.Lib.encodings', 'venv.Lib.site-packages.pip',
              ...
              'venv.Lib.site-packages.pkg_resources._vendor.packaging', 'tests', 'tests.PersonService',
              'tests.MiscProduction', 'tests.MiscLowerLanes', 'tests.MarketingService', 'utils', 'config'],
    url='',
    license='',
    author='kspringall',
    author_email='',
